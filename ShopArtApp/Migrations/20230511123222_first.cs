    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommandDetailId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommandDetails", x => x.CommandDetailId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BillAddressId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillAddresses", x => x.BillAddressId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idFind = table.Column<int>(type: "int", nullable: false),
                    BillAddressId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
